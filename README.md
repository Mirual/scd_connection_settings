...
> [!CAUTION]
> Любые окружения и пакеты сами НЕ СТАВИМ, пишем мне или еще кому-то.
## Установка и настройка VPN
Безопасность - наше все, поэтому к серверам мы подключаемся через VPN
### Установка:
* Установить [openvpn gui для вашей системы]([https://openvpn.net/community-downloads/](https://openvpn.net/client/))
### Подключение:
